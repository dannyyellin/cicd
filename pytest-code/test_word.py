...
# def test_get_word_all_words():
#     word = {"word": "book"}
#     response = connectionController.http_post("words",word)
#     assert_valid_added_resource(response)
#     word_collection[response.json()] = "book"
#     return response.json()
#
#     response = connectionController.http_get(f"dishes/{milk_id}")
#     assert_err_code(response, status_code=200)
